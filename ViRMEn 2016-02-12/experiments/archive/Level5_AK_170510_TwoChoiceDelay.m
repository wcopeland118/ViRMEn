function code = Level5_AK_170510_TwoChoiceDelay
...
switch vr.STATE
    ...
    case 'TRIAL'
        ...
        if abs(vr.position(1)) > eval(vr.exper.variables.armLength)/vr.armFac            
            ...
            vr.trialRecord(vr.trialCount).success=vr.isReward;
    ...
    case 'INIT_ITI'
        ...
        dataStruct=struct('success',vr.trialRecord(vr.trialCount).success,'conds',vr.cuePos,...
            'greyFac',vr.greyFac); 
